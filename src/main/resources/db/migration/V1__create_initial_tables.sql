...
CREATE TABLE t_authority (id SERIAL PRIMARY KEY, logic VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, uuid VARCHAR(64) NOT NULL);

CREATE TABLE t_project (description text NULL, id SERIAL PRIMARY KEY, title VARCHAR(255) NOT NULL, uuid VARCHAR(64) NOT NULL, authority_fk INTEGER NOT NULL);
