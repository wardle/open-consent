...
CREATE TABLE t_project (description text NULL, id SERIAL PRIMARY KEY, title VARCHAR(255) NOT NULL UNIQUE, uuid VARCHAR(64) NOT NULL, authority_fk INTEGER NOT NULL);
