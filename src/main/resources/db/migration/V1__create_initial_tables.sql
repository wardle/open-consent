CREATE TABLE t_patient (encrypted_email text NOT NULL, encrypted_encryption_key text NOT NULL, encrypted_name text NOT NULL, hashed_email VARCHAR(255) NOT NULL, hashed_password VARCHAR(255) NOT NULL, id SERIAL PRIMARY KEY);
